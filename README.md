...
This is a starter kit for [Gatsby.js](https://www.gatsbyjs.org/) presentation written in TypeScript & MDX. It includes the bare essentials for you to get started (styling, minimal toolset).
