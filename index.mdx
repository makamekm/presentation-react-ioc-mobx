...
<Badge>The current vesrions (1.x, 2.x) don't support TypeScript</Badge>

<sub>VueJS 3 will support it</sub>
...
2. But there are limitations with replacing arrays
