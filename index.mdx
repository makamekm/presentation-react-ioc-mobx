...
<Appear>
  <OnAppear fade>
    <div style={{display: 'flex', flexDirection: 'column', textAlign: 'left', width: "100%", justifyContent: "center"}}>
      <BigPanel style={{display: 'inline-block'}} color="#4591EA">
        > Architecture & Tools are very important
      </BigPanel>
      <BigPanel style={{display: 'inline-block', marginTop: "20px"}} color="#4591EA">
...
<OnAppear fade logo width="100vw" align="left">
...
```tsx subtitle="Import React" file=./components/panel.tsx
```
...
<div>
  <Terminal
    ...
    lines={[
      ...
      {
        'text': 'gatsby new my-presentation https://github.com/makamekm/gatsby-starter-presentation',
        'cmd': true,
      },
      loadingSpinner({
        onLoading: 'Initializing...',
